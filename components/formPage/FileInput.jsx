  ...
  return (
    <div className="">
      <button
        ...
        className="flex items-center justify-between gap-7 border border-zinc-300 px-2.5 py-2 rounded-md text-neutral-400 text-sm font-medium tracking-tight shadow"
      >
        {name !== "Document" && "Click to drawing document"}
        {name === "Document" && "Click to upload document"}
        <BiUpload className="text-zinc-800" size={16} />
      </button>
      <Modal
        id={id}
        heading={"Upload"}
