...
const VendorItemDetails = dynamic(
    () => import("@/components/modals/VendorItemDetails")
);
...
const VendorViewPage = () => {
    ...
    const cancelledCheque = vendor && vendor.vendor?.documents?.length > 0 ? vendor.vendor.documents.find((doc) => doc.document_name === "Cancelled Cheque") : null;
    ...
    return (
        <>
                ...
                <div className="flex gap-2">
                    <Button
                        onClick={() => {
                            ...
                            openModal("show-vendor-item-details");
                        }}
                    ...
                    <Button
                        onClick={() => router.push(`/masters/vendors/edit-vendor-details/${id}`)}
                        className="px-4 flex items-center gap-2"
                    >
                        <FaEdit size={16} />
                        Edit Details
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-1 overflow-auto">
                {/* Company Details */}
                <InfoCard
                ...
                <div className="lg:col-span-2">
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <DocumentLink label="Cancelled Cheque" url={cancelledCheque?.document} />
                        </div>
                    </InfoCard>
                </div>
            ...
            {selectedRow && <VendorItemDetails selectedItem={selectedRow} />}
        </>
    );
};
