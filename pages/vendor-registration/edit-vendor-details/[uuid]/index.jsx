...
import { getStates, getCity, uploadDocument, getVendors, editVendor } from "@/services/vendor-services/api";
...
const EditVendorRegistrationForm = () => {
    ...
    const handleSubmitForm = async () => {
        ...
        await requestHandler(
            async () => await editVendor(payload),
            null,
            (data) => {
        ...
        <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4 overflow-scroll">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-left mb-8">
                    <h1 className="text-3xl font-bold text-zinc-800 mb-2">Edit Vendor</h1>
                </div>
